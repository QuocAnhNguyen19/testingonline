...
<form method="post" id="updateCourseFrm">
  ...
  <div class="form-group">
      <legend>Tên Cán Bộ Giảng Dạy</legend>
    <input type="hidden" name="course_author" value="<?php echo $id; ?>">
    <input type="" name="newCourseauthor" class="form-control" required="" value="<?php echo $selCourse['cou_author']; ?>" >
  </div>
