...
<?php 
   ...
   if($page != '')
   {
     ...
     else if($page == "manage-chapter")
     {
      include("pages/manage-chapter.php");
     }
     ...
     else if($page == "detailQuestion")
     {
      include("chitietcauhoi.php");
     }
     else if($page == "quanlycanbo")
     {
      include("pages/quanlycanbo.php");
     }
