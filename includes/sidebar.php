    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="app-sidebar__heading">BÀI KIỂM TRA HIỆN CÓ</li>
                <li>
                <a href="#" >
                     <i class="metismenu-icon pe-7s-display2"></i>
                     Các bài kiểm tra đang mở
                ...
                <ul >
                    ...
                    <?php 
                        ...
                        { ?>
                            <a href="#">
                                <i class="metismenu-icon"></i>Không có bài kiểm tra hiện tại
                            </a>
                        <?php }
                     ?>
                 ...
                 <li class="app-sidebar__heading">BÀI THI ĐÃ HOÀN THÀNH</li>
                <li>
                  <?php 
                    ...
                    { ?>
                        <a href="#" class="pl-3">CHƯA CÓ DỮ LIỆU</a>
                    <?php }
                ...
                <li class="app-sidebar__heading">PHẢN HỒI</li>
                <li>
                    <a href="#" data-toggle="modal" data-target="#feedbacksModal" >
                        THÊM PHẢN HỒI MỚI                
                    </a>
                </li>
                <!-- <li class="app-sidebar__heading">Video cac bai on tap</li>
                <li>
                    <a href="#"  >
